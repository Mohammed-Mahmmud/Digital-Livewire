                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="skill mb-4">
                            <div class="d-flex justify-content-between">
                                <p class="mb-2"><?php echo e($skill->name); ?></p>
                                <p class="mb-2"><?php echo e($skill->progress); ?>%</p>
                            </div>
                            <div class="progress">
                                <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="<?php echo e($skill->progress); ?>"
...
<!-- About End -->
<?php /**PATH /home/mohamed-khater/Documents/projects/Digital-Livewire/DigitalLivewire/resources/views/components/front/partials/skills-component.blade.php ENDPATH**/ ?>