...
<?php $component = App\View\Components\Dashboard\Layouts\Modal::resolve(['id' => 'updateModalToggle','title' => 'Edit Skills'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
