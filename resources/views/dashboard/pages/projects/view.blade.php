                  ...
                  @if (count($data) > 0)
                      @foreach ($data as $item)
                          <tr class="table-light">
                              ...
                              <td>{{ $item->name }}</td>
                              <td><span class="badge bg-label-info me-1">{{ $item->link }}</span></td>
                              <td>
                                  ...
                                  <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu ">
                                          <a class="dropdown-item" href="#"
                                              wire:click.prevent="$dispatchTo('dashboard.pages.projects.update','edit',{id:{{ $item->id }}})"><i
                                                  class="bx bx-edit-alt me-1"></i>
                                              Edit</a>
                                          <a class="dropdown-item" href="#"
                                              wire:click.prevent="$dispatchTo('dashboard.pages.projects.delete','destroy',{id:{{ $item->id }}})"><i
