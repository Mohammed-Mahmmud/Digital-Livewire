                                  ...
                                  <div class="dropdown">
                                      ...
                                      <div class="dropdown-menu ">
                                          <a class="dropdown-item" href="#"
                                              wire:click.prevent="$dispatchTo('dashboard.pages.categories.update','edit',{id:{{ $item->id }}})"><i
                                                  class="bx bx-edit-alt me-1"></i>
                                              Edit</a>
                                          <a class="dropdown-item" href="#"
                                              wire:click.prevent="$dispatchTo('dashboard.pages.categories.delete','destroy',{id:{{ $item->id }}})"><i
